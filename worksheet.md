...
1. Next add a new sprite by clicking on the `import a new sprite` icon on the sprites palette (it looks like the image below) and select `Astronaut-Tim` from the choices and click **Ok**.
